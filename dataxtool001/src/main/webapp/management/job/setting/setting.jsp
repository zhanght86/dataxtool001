...
<title>Insert title here</title>
	...
	<script type="text/javascript" src="/dataxtool001/management/job/setting/setting.js"></script>
</head>
	<body>
		...
		<div id="win" class="easyui-window" title="My Window" style="width:600px;height:400px"   
			...
			<input id="cc" name="dept" value="aa">
					    <!-- 输入框 -->
		   <input id="shurukuang" class="easyui-validatebox" data-options="required:true" />
			<input id="shurukuang2" class="easyui-validatebox" data-options="required:true" />
			<!-- 创建按钮 -->
